...
const VITE_GPT_KEY = "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"
const VITE_GPT_URL = "https://api.openai.com/v1/completions"
...
export const GpTalks = () => {
  ...
  /*----- --- THIS IS SUPPOSED TO BE A custom hook,src/components/TheForm/TheForm.jsx
  ...
  const useGptResponse = () => {
    ...
    const fetcherFnc = async () => {
      ...
      try {
        const response = await fetch(VITE_GPT_URL, payload)
